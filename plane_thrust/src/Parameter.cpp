...
bool Parameter::readParam(const char *addr) {
    ...
    while (!fs.eof())
    {
        ...
        if (name == "thrust_z_pos_P_I_D")
        {
            error_z_pos_P = value[0];
            error_z_pos_I = value[1];
            error_z_pos_D = value[2];
        }
        if (name == "thrust_z_vel_P_I_D")
        {
            error_z_vel_P = value[0];
            error_z_vel_I = value[1];
            error_z_vel_D = value[2];
        }
